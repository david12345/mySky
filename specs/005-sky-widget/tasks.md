...
- [X] T044 Validação manual de [quickstart.md](./quickstart.md), com prioridade para a **secção 4** (o widget partido da v1.0.0, que só é reproduzível uma vez) e a **secção 7** (0 ou 1 trabalho, sempre)
